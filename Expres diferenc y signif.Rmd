...
load(file = 'C:/Users/Copito/OneDrive/Documentos/Master bioinf y bioest/TFM/datasets/GSE26713/')
...
```{r, warning=TRUE, error=FALSE}
grupColors <- unlist(lapply(GSE26713_grupos, GSE26713_colores))
heatmap(exprs2cluster, col = rainbow(100), ColSideColors = cols, cexCol = 0.9)
...
cont.matrix <- makeContrasts(CALMAF10_CALMHOX = CALM_AF10 - HOX,
                             ...
                             HOXAUnk_MLL = HOXA_of_Unknown_Mechanism - TAL_R,
                             ...
                             Immature_MLL = Immature - MLL_t,
                             Immature_TAL = Immature - TAL_R,
                             Immature_TLX1 = Immature - TLX1,
                             Immature_TLX3 = Immature - TLX3,
                             
                             ImmHOXA_MLL = Immature_HOXA13_t - MLL_t,
                             ImmHOXA_TAL = Immature_HOXA13_t - TAL_R,
...
universes <- list(geneUniverse_1,geneUniverse_2,
                  ...
                  geneUniverse_36,geneUniverse_37,
