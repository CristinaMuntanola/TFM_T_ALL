...
GSE62156_eset_rma <- rma(GSE62156_rawData)
```

```{r, message=FALSE, echo=TRUE}
show(annotation(GSE62156_eset_rma))
```
...
```{r, message=FALSE, echo=TRUE}
require(hgu133plus2.db)
annotation(GSE62156_eset_rma) <- "hgu133plus2.db"
```
...
```{r, message=FALSE, echo=TRUE}
library(genefilter)
GSE62156_Filtered <- nsFilter(GSE62156_eset_rma,
                              require.entrez =
                                TRUE,
                     remove.dupEntrez = TRUE,
                     var.func = IQR,
